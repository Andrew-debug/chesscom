...
const notifyFront = debounce(() => { window.dispatchEvent(stockfishResultsUpdated) }, 100)
const stPost = (text) => {
  console.log('SEND :::: ', text)
  stockfish.postMessage(text)
}
// init stockfish
const stockfish = new Worker('node_modules/stockfish/src/stockfish.js', { type: 'module' },)
